        ...
        <div className="max-w-xs bg-white border border-gray-200 rounded-lg hover:shadow-2xl transition-shadow flex flex-col">
            ...
            <Link href="/services">
                <div className="px-4 py-3 cursor-pointer flex-1 flex flex-col">
                    <h5 className="mb-2 text-lg font-semibold tracking-tight text-[#1A1F65]" data-aos="fade-up" data-aos-delay="500">{data.title}</h5>
                    <p className="mb-3 text-normal text-gray-700 dark:text-gray-400 text-justify" data-aos="fade-up" data-aos-delay="500">{data.desc}</p>
                    <p className='flex-1 justify-self-end' data-aos="fade-up" data-aos-delay="500"></p>
                    <p data-aos="fade-up" data-aos-delay="500" className="flex w-fit items-center px-2 py-[0.4rem] text-sm text-center font-semibold bg-[#0f588c] hover:bg-sky-700 transition-all text-white rounded-2xl shadow-lg">
                        Get more detail
