                    ...
                    return (
                        <div className='h-full w-full m-auto relative' key={i}>
                            ...
                            <div className='absolute top-0 h-[100%] w-full text-white flex items-center justify-center flex-col gap-4'>
                                <h2 className='lg:text-5xl md:text-4xl text-lg font-bold text-center'>{item.desc}</h2>
                                <div className='flex gap-4 items-center px-3 py-1 lg:px-5 lg:py-2 cursor-pointer w-fit font-medium hover:text-[#1A1F65] hover:bg-white hover:shadow-lg transition-all text-white rounded-2xl'>
