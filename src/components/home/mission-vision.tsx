...
const MissionVision = () => {
  return (
    <div className='flex flex-col gap-5 lg:flex-row py-8 md:py-16 w-full px-4 max-w-6xl mx-auto'>
      <div className='basis-2/3 pr-5 flex flex-col gap-5' data-aos="fade-right" data-aos-delay="500">
      ...
      <div className='basis-1/3 flex items-center justify-center' data-aos="fade-left" data-aos-delay="500">
